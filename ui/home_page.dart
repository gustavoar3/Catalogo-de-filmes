...
import 'dart:convert';
import 'package:catalogofilmes/ui/movie_page.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Future<Map> _getMovies() async {
    ...
    response = await http.get(Uri.parse(
        "https://api.themoviedb.org/3/movie/top_rated?api_key=f3763988c18a6f3953cfd3c6f32d3c67&language=pt-BR&page=1"));
